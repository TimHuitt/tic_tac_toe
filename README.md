...
2. Review the requirements and pseudo-code examples below.
3. Write your own pseudocode notes in a `pseudocode.txt` file. 
4. Design and architect your TTT game according to the requirements.
5. Only after the game is working, should you consider styling the app.
